from utils.descripcion_rutinas import describir_datos_rutinas
from utils.descripcion_videos import describir_datos_videos
...
from utils.descripcion_usuario import describir_datos_usuario
import pandas as pd
...
describir_datos_videos(videos_ordenados)
...
describir_datos_rutinas(rutinas_ordenadas)
